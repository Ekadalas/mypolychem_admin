    ...
    <div class="col-md-12">
        <div class="card shadow border-left-info py-3">
            <div class="card-body">
                ...
                <!-- Form Utama -->
                <form action="<?= site_url('C_data_pertanyaan/getPertanyaanByGradeHardCom'); ?>" method="post" id="formPertanyaan">

                    <!-- Header -->
                    <div class="card-header bg-light">
    <div class="d-flex flex-column">
        <div class="card-title text-dark" style="font-size: 20px; font-weight: 500; margin-bottom: 0.5rem;">
            Pertanyaan yang dipilih: <?= strtoupper($selected_type_pertanyaan); ?>
        </div>
        <div class="card-subtitle text-secondary" style="font-size: 16px; font-weight: 400;">
            Grade yang dipilih: <?= strtoupper($selected_grade); ?>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg"> <!-- Ukuran modal diperbesar -->
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo site_url('C_data_pertanyaan/updatepertanyaan'); ?>" method="post">
                    <div class="mb-3">

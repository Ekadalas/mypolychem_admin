...
<form>
  <button type="submit" id="plusPlus" class="btn btn-outline-info" formaction="<?= site_url('C_matrix_penilaian_sls/tambah'); ?>"> Data Penilai Baru <i class="fas fa-plus"></i></button>

  <button type="submit" class="btn btn-outline-warning"  onclick="wadahNik()" formaction="<?= site_url('C_matrix_penilaian_sls/edit_penilai') ?>" id="klikEdit" > Ubah<i class="far fa-edit "></i> </button>

       <button type="submit" id="apusDelet" class="btn btn-outline-danger" onclick="wadahNik()" formaction="<?= site_url('C_matrix_penilaian_sls/hapus') ?>">Hapus <i class="far fa-trash-alt"></i></button>
  ...
  <div class="col-md-12">
   ...
   $(document).ready(function () {
    ...
    $('#klikEdit').on('click', function (e) {
        ...
        var actionUrl = "<?= site_url('C_matrix_penilaian_sls/edit_penilai') ?>?input_id=" + selectedValue.join(',');
      ...
      if (selected.length === 0) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            console.log(result);
            $.ajax({
              url: "<?= site_url('C_matrix_penilaian_sls/hapus') ?>",
              type: "POST",

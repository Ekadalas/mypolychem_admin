  ...
  <?php $nip = $this->session->userdata('nip_btn'); ?>
 	<div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            DATA MONITORING PENILAIAN SLS
            </div>
            </div>
            <div class="col-auto">
            <img style="width: 100px; height: 60px;" src="<?php echo base_url('assets/img/prosess.svg')?>">
            ...
            <form class="form-inline" method="post" action="<?php echo site_url('C_monitoring_penilaian_sls/filter'); ?>">
            ...
            <button type="submit" class="btn btn-warning mb-2">Filter<i class="fas fa-search"></i></button>
            </form>
    ...
    <div class="card shadow">
      ...
      <div class="card-body">
        <div class="table-responsive" id="filteredTable">
          ...
          <?php if (!empty($monitor_sls)): ?>
          <tbody style="font-size: 11px; color: black;">
          <?php
          $no = 1;

          foreach ($monitor_sls as $k) {
         ...
         <td>
          ...
          <!-- Data akan diisi dari JS -->
              ...
              $.ajax({
              url: '<?= site_url("C_monitoring_penilaian_sls/getDetailPenilaian") ?>', // URL yang dipanggil untuk mendapatkan data
              type: 'POST',

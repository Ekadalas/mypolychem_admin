...
<body id="page-top">
  ...
  <form method="POST" action="<?php echo site_url('C_izin/tampil_izin'); ?>">
  <div class="row">
  <div class="col-lg-2">
 ...
 <div class="row my-4">
  <div class="col-md-12">
    <div class="card shadow">
         <div class="card border-left-info shadow py-3" style="min-height: auto;">
      <div class="card-body">
        <div class="table-responsive" id="tabelfilter">

					<!-- <a href="<?= site_url('C_izin/izin_belum_disetujui/' . $nip); ?>">
					*Klik tautan berikut untuk melihat data izin yang belum disetujui atasan
					</a> -->
                             ...
                             <?php
                              ...
                              foreach ($data as $k) {
                                  ...
                                  $cd_office  = $k['cd_office'];
																	$tgl_input = isset($k['date_input']) ? date('Y-m-d', strtotime($k['date_input'])) : '';
																	$tgl_mulai = isset($k['date_start']) ? date('Y-m-d', strtotime($k['date_start'])) : '';
																	$tgl_akhir = isset($k['date_end']) ? date('Y-m-d', strtotime($k['date_end'])) : '';
                                  $izin       = $k['lama_izin'];
                                  $absensi    = $k['cd_absensi'];
                                  $ket        = $k['remark'];
                              ...
                              <tr>
                                ...
                                <td><?php echo $ket;?></td>
																<td>
																	<a class="btn btn-info btn-xs" href="<?php echo site_url('C_izin/setujui_admin/'.$nip_btn.'/'.$id) ?>"
																	onclick="return confirm('Apakah admin yakin ingin melakukan persetujuan izin ?')">
																	Approve
																	</a>
																</td>
                              </tr>

           ...
           <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody style="font-size: 12px; color: black;">
                             <?php
                              ...
                              foreach ($data_cuti_belum_disetujui as $k) {
																	$id         = $k['id'];
                                  $nip_btn    = $k['nip_btn'];
                                  $name       = $k['name'];
                              ...
                              <tr>
                                ...
                                <td><?php echo $vacation; ?></td>
																<td>
																	<a class="btn btn-info btn-xs" href="<?php echo site_url('C_cuti/setujui_admin/'.$nip.'/'.$nip_btn.'/'.$id) ?>"
																	onclick="return confirm('Apakah admin yakin ingin melakukan persetujuan cuti ?')">
																	Approve
																	</a>
																</td>

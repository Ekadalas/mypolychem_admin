...
class M_data_pertanyaan_sls extends CI_Model
{

	
    public function pilihGrade() 
    {
    ...
    $data = $this->db->query("SELECT DISTINCT 
                                CASE 
                                  ...
                                  ELSE 'Unknown'
                                END AS grade_group
                                FROM data_pertanyaan_sls");
        return $data->result_array();
    }

    
  public function hardSoft() 
  {
  ...
  public function update_pertanyaan($data) {
    ...
    // Proses update
    $this->db->update('data_pertanyaan_sls');
